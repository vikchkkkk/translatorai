...
# --- SIDEBAR (Обновлено: состав команды и модуль) ---
with st.sidebar:
    st.title("О проекте")
    st.markdown("""
    **Программа:** [Цифровые кафедры УрФУ](https://dpo.urfu.ru/programs/92)
    
    **Команда:** Бахарева Екатерина, Вебер Мария, Ветчанинова Яна, Рехин Александр, Ряполова Виктория, Савченко Елизавета, Саянская Анна, Слепцова Екатерина, Соловьева Екатерина, Чикризова Марина, Югай Анна
    
    **Контекст:** Модуль практической подготовки
    """)
...
# Добавлено уточнение по языкам согласно фидбеку
st.write("""
Загрузите фото любого формата — модель сама найдет все строки.  
**Поддерживаемые языки:** английский и французский.
""")
